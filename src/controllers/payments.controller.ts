...
export class PaymentController {
  ...
  async create(
    ...
    console.log('testingrequest', req);
    ...
    const balanceResult: any = await this.bankInfoService
      .getPlaidBalance(plaidAccessToken)
      .then((balance) => {
        console.log('resultupdated', balance);
        return balance;
      })
      .catch((error) => {
